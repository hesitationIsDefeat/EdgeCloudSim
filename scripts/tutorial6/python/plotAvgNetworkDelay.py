...
if __name__ == '__main__':
    ...
    # plot_generic_line(5, 1, 'Average WLAN Delay for Photo Message App (sec)', 'PHOTO_MESSAGE', '', 'upper left')

    # # Group 3: MAN Delay
    # plot_generic_line(5, 2, 'Average MAN Delay (sec)', 'ALL_APPS', '', 'upper right')
    # plot_generic_line(5, 2, 'Average MAN Delay\nfor Text Message App (sec)', 'TEXT_MESSAGE', '', 'upper right')
    # plot_generic_line(5, 2, 'Average MAN Delay for Photo Message App (sec)', 'PHOTO_MESSAGE', '', 'lower left')

    # # Group 4: WAN Delay
    # plot_generic_line(5, 3, 'Average WAN Delay (sec)', 'ALL_APPS', '', 'upper left')
    # plot_generic_line(5, 3, 'Average WAN Delay\nfor Text Message App (sec)', 'TEXT_MESSAGE', '', 'upper left')
    # plot_generic_line(5, 3, 'Average WAN Delay for Photo Message App (sec)', 'PHOTO_MESSAGE', '', 'upper left')