...
# "VORONOI_<factor>" there is enough; no python changes needed.
...
def _make_legend(scenario_type):
    """Turns 'VORONOI'/'VORONOI_2' into 'VORONOI (1x)'/'VORONOI (2x)'."""
...
def get_configuration():
    ...
    config = {
        'folder_path': '../../../sim_results/tutorial9',
        'output_folder_path': os.path.join('../../../sim_results/tutorial9', _load_tutorial_display_name('tutorial9')),
        'num_iterations': 10,
        'x_tick_interval': 1,
