...
# results later doesn't require cross-referencing scripts/tutorial9/config (which may
...
tutorial_name=$(grep "^tutorial9=" "$tutorial_names_file" 2>/dev/null | cut -d'=' -f2- | tr -d '\r')
: "${tutorial_name:=tutorial9}"
results_dir="../../../sim_results/tutorial9/${tutorial_name}"
mkdir -p "$results_dir"
