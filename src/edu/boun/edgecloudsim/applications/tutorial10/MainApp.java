...
// ONAT: tutorial10 = tutorial9's wiring, but UAV mobility is CENTRALIZED: a single
// controller (CentralizedUAVMobility) with full scene visibility decides every UAV's
// next move, instead of each UAV deciding for itself. uav_mobility_options sweeps
// centralized policies (NO, RANDOM - see CentralizedUAVMobility.runControlTick and
// SampleScenarioFactory.getEdgeMobilityModel()).
...
public class MainApp {
    ...
    public static final String APPLICATION_FOLDER = "tutorial10";
