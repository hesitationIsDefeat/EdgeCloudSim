...
/**
 * Scenario factory for tutorial10, combining the normal-user population from
 ...
 * to tutorial8/9's wiring for everything except UAV mobility). Unlike tutorial8/9
 * (decentralized UAV policies, each UAV deciding its own move), this tutorial's
 * {@code uav_mobility_options} (see default_config.properties) sweeps CENTRALIZED
 * policies: a single controller with full scene visibility (see
 * {@link CentralizedUAVMobility}) decides every UAV's next move.
