...
// ONAT: tutorial12 = tutorial10, but uav_mobility_options is restricted to
// PRIORITY_KMEANS policy variants ("PRIORITY_KMEANS", "PRIORITY_KMEANS_8", ...) so a
// single sweep compares different SAR priority factors under the centralized
// PRIORITY_KMEANS policy (see CentralizedUAVMobility.isPriorityKMeansPolicy /
// parseExplicitPriorityFactor and SampleScenarioFactory.getMobilityModel()) - the
// centralized analogue of tutorial9's VORONOI-variant sweep.
...
public class MainApp {
    ...
    public static final String APPLICATION_FOLDER = "tutorial12";
