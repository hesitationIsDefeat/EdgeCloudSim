...
// ONAT: tutorial11 = tutorial9's wiring, but compares one DECENTRALIZED UAV mobility
// policy (VORONOI, BasicUAVMobility - every UAV decides its own move) against one
// CENTRALIZED policy (PRIORITY_KMEANS, CentralizedUAVMobility - a single controller
// with full scene visibility decides every UAV's move) in the same
// uav_mobility_options sweep (see SampleScenarioFactory.getEdgeMobilityModel()).
...
public class MainApp {
    ...
    public static final String APPLICATION_FOLDER = "tutorial11";
