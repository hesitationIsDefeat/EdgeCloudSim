...
public class MainApp {
    ...
    public static final String APPLICATION_FOLDER = "tutorial7";
                ...
                for(int k=0; k<SS.getSimulationScenarios().length; k++)
                {
                    ...
                    for(int i=0; i<SS.getOrchestratorPolicies().length; i++)
                    {
                        ...
                        for (int u=0; u<SS.getUAVMobilityOptions().length; u++) {
                            ...
                            // Evaluate each task partition option under active scenario
                            for (int t=0; t<SS.getTaskPartitionOptions().length; t++) {
                                // Extract current test dimensions
                                String simScenario = SS.getSimulationScenarios()[k];
                                String orchestratorPolicy = SS.getOrchestratorPolicies()[i];
                                String uavMobilityOption = SS.getUAVMobilityOptions()[u];
                                String taskPartitionOption = SS.getTaskPartitionOptions()[t];
                                ...
                                SimLogger.printLine("Scenario: " + simScenario + " - Policy: " + orchestratorPolicy + " - UAV Mobility: " + uavMobilityOption + " - Task Partition: " + taskPartitionOption + " - #iteration: " + iterationNumber);
                                ...
                                SimLogger.getInstance().simStarted(outputFolder,"SIMRESULT_" + simScenario + "_"  + orchestratorPolicy + "_" + uavMobilityOption + "_" + taskPartitionOption + "_" + j + "DEVICES");
                                ...
                                try
                                {
                                    ...
                                    ScenarioFactory sampleFactory = new SampleScenarioFactory(j,SS.getSimulationTime(), orchestratorPolicy, simScenario, uavMobilityOption, taskPartitionOption);
