...
// ONAT: tutorial9 = tutorial8, but uav_mobility_options is restricted to VORONOI
// policy variants ("VORONOI", "VORONOI_2", "VORONOI_4", ...) so a single sweep
// compares different SAR priority factors (see BasicUAVMobility.isVoronoiPolicy /
// parseExplicitPriorityFactor and SampleScenarioFactory.getMobilityModel()).
...
public class MainApp {
    ...
    public static final String APPLICATION_FOLDER = "tutorial9";
